...
{%- endcapture -%}
<br><br>
In ProteinGuide, the guided predictions for the next amino acid come from multiplying the predictive model's probability for getting a high fitness variant with the generative model's probability for that amino acid resulting in a realistic protein and renormalizing{% sidenote bayes_note_ %}. Informally, we can write this as:
