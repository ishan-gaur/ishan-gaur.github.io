...
<figure>
  <div data-proteinguide-reward-hacking="left-shift-diffuse-predictor"></div>
</figure>
...
Putting everything together, the following is a simple default workflow for using ProteinGuide in the lab. For further implementation details, check out the [ProteinGuide Python Workflow on ProteinGen](https://ishan-gaur.github.io/proteingen/workflows/protein-guide/).
